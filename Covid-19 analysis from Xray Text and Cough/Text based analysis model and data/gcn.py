...
def create_gcn_branch(inputs):
    def __init__(self):
        super().__init__()
        self.conv1 = GCNConv(inputs.num_node_features, 16)
        self.conv2 = GCNConv(16, inputs.num_classes)
...
def create_model(max_sequence_length=100, vocab_size=20000, embedding_dim=200, lstm_units=128,
    ...
    # Dense layer
    gcn_layer = create_gcn_branch(embedding_layer)
    
    # Dense layer
    dense_layer = Dense(dense_units, activation='relu')(gcn_layer)
