...
def create_bilstm_branch(embedding_layer, lstm_units=128):
    lstm_layer = Bidirectional((lstm_units)(embedding_layer))
    return lstm_layer
...
def create_model(max_sequence_length=100, vocab_size=20000, embedding_dim=200, lstm_units=128,
    ...
    # Dense layer
    dense_layer = Dense(dense_units, activation='relu')(bilstm_branch)
