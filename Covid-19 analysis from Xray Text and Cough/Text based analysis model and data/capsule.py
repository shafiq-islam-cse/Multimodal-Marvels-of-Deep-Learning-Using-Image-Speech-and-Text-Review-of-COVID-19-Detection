...
maxlen = 72 # max number of words in a text #99.99%

# A Capsule Implement with Pure Keras
def create_capsule_branch(Layer):
...
def create_model(max_sequence_length=100, vocab_size=20000, embedding_dim=200, lstm_units=128,
    ...
    # Dense layer
    capsule_layer = create_capsule_branch(embedding_layer)
    
    # Dense layer
    dense_layer = Dense(dense_units, activation='relu')(capsule_layer)
