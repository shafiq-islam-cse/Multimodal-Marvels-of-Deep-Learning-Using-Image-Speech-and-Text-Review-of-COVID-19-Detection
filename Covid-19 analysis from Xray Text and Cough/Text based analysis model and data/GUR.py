...
def create_gru_branch(embedding_layer, gru_units=128):
    gru_layer = GRU(gru_units)(embedding_layer)
    return lstm_layer
...
def create_model(max_sequence_length=100, vocab_size=20000, embedding_dim=200, gru_units=128,
    ...
    # GRU branch
    gru_branch = create_gru_branch(embedding_layer, gru_units=gru_units)

    # Concatenation
    #concat_layer = Concatenate()([lstm_branch, cnn_branch])

    # Dense layer
    dense_layer = Dense(dense_units, activation='relu')(gru_branch)
